...
function QuestionDetails() {
    ...
    const handlePostAns = async (e, id) => {
        e.preventDefault();
        console.log(User)
            ...
            if (Answer === '') {
                ...
                try {
                    const response = await fetch(`https://stack-overflow-nullclass-backend.onrender.com/answers/post/${id}`, {
                        ...
                        body: JSON.stringify({
                            answerBody: Answer,
                            userAnswered: name, // assuming User has a name property
                            userId: userId, // assuming User has an id property
                        })
                    });
                    ...
                    // Reset Answer state or update question data if needed
                    setAnswer(''); // Assuming you have setAnswer as part of state management
                    // Optionally, you might want to reload the answers list here
                } catch (err) {
                    console.log("Error posting answer:", err.message);
                }
            }
        }
    };
                    ...
                    questionsList.data.filter(question => question._id === id).map(question => (
                        <div key={question._id}>
                                    ...
                                    <div style={{ width: "100%" }}>
                                        ...
                                        <div className="ques-action-user">
                                            ...
                                            <div>
                                                ...
                                                <Link to={`/Users/${question.userId}`} className="user-link" style={{ textDecoration: "none", color: "#00868d" }}>
                            ...
                            <section className="post-ans-container">
                                <h3>Your Answer</h3>
                                <form onSubmit={(e) => { handlePostAns(e, question._id) }}>
